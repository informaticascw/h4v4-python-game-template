...
- work around included for 
Sub-process /usr/bin/sqv returned an error code (1), error message is: Missing key FF7CB5667B542092084BBDC562D54FD4003F6525, which is needed to verify signature.
